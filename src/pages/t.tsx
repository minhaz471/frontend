        ...
        <div className="flex-grow mx-4 max-w-[200px]">
          {screenWidth > 1000 ? (
            <input
              type="text"
              placeholder="Search..."
              className="w-full w-100px px-4 py-2 rounded-full border-none outline-none bg-gray-100 transition focus:bg-white focus:border-gray-300 text-sm text-black"
            />
          ) : (
            <FontAwesomeIcon
              icon={faSearch}
